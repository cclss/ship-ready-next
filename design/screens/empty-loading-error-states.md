...
- [ ] Filtered/search empty state is compact and offers Clear filters; it never reuses the first-use illustration
...
- [ ] Transient errors and successes use toasts that auto-dismiss in 5 s, stack ≤ 3, and offer Undo/Retry when meaningful
